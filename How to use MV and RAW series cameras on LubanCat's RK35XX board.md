...
# How to use MV and RAW series cameras on LubanCat-5-BTB RK35XX board
This is a mirror of [our wiki article](https://wiki.veye.cc/index.php?title=MV_Camera_on_LubanCat_Boards).
...
This article takes LubanCat-5-BTB board as an example to introduce how to connect MV and RAW series cameras to the RK3566/3K3568 system.

We provide drivers for the Linux operating system (using LubanCat-5-BTB OS Debainas an example).
...
Then, connect it to the [ADP-MV1-V2](https://wiki.veye.cc/index.php/ADP-MV1-V2_Adapter_Board_Data_Sheet) adapter board using the FPC15T22P-1.0T0.5MM-20CM-T connector, and then connect it to the camera end through this adapter board.

![LubanCat-5-BTB_connect_to_MV_camera](resources/LubanCat-5-BTB_connect_to_MV_camera.jpg)
...
![LubanCat-5-BTB_connect_to_RAW-MIPI-SC132M](resources/LubanCat-5-BTB_connect_to_RAW-MIPI-SC132M.jpg)


### Connection of other RAW series camera and LubanCat-5-BTB
...
![LubanCat-5-BTB_connect_to_RAW_series_camera](resources/LubanCat-5-BTB_connect_to_RAW_series_camera.jpg)
...
- i2c toolkits
- application demo
In addition, a compiled linux kernel installation package and Android image is provided in the [releases](https://github.com/veyeimaging/rk35xx_LubanCat/releases).
...
Download the latest debs.tar.tar.gz from https://github.com/veyeimaging/rk35xx_LubanCat/releases/ .
...
See the [samples](https://github.com/veyeimaging/rk35xx_LubanCat/tree/main/linux/samples) directory on github for details.
```
...
We provide several gstreamer routines that implement the preview function. See the [samples](https://github.com/veyeimaging/rk35xx_LubanCat/tree/main/linux/samples) directory on github for details.
